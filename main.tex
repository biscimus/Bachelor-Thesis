...
\usepackage{tikz}
\usetikzlibrary{petri,positioning, automata, arrows.meta}

%%%%% PADS TEMPLATE SETTINGS %%%%%
\renewcommand{\gTitle}{Translucify: Enhancing Event Logs with Enabled Activities Beyond the Control-Flow Perspective}
